...
#sed "s/GUID/${GUID}/g" manifests/tasks-dc-blue.yaml | oc apply -f - -n ${GUID}-tasks-prod
...
#sed "s/GUID/${GUID}/g" manifests/tasks-dc-green.yaml | oc apply -f - -n ${GUID}-tasks-prod
